...
suite('Functional Tests', () => {
  ...
  test('Translation with text that needs no translation: POST request to /api/translate', (done) => {
    ...
    .keepOpen()
    .post('/api/translate')
    .send({text: 'Text no need to translate', locale: 'american-to-british'})
    .end((err, res) => {
      assert.deepEqual(res.body, {text: 'Text no need to translate', translation: 'Everything looks good to me!'})
      done()
    })
  })
});
